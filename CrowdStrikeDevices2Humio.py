...
def main():
    ...
    kwargs = {'clientID':clientID, 'secret':secret, 'falcon':falcon, 'log_file':log_file, 'log_level':log_level, 'version':version, 'proxy':proxy_used, 'proxies':proxies}
    ...
    for details in device_details:
        ...
        try: 
            sys.exit('Devices2Humio v' + version + ': Data collection has successfully completed, CrowdStrike Device Data 2 Humio is now exiting.')
        except:
            pass
